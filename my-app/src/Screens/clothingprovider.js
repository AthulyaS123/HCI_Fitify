...
export const ClothingProvider = ({ children }) => {
  const [clothingItems, setClothingItems] = useState([
    ...
    { id: 17, name: "White Sneakers", img: Clothes.unishoe2, color: "black", occasion: "music-festival", gender: "unisex", aesthetic: "going-out/cute", category: "shoe"},
    ...
    { id: 25, name: "White Sneakers", img: Clothes.mascshoe1, color: "white", occasion: "music-festival", gender: "masculine", aesthetic: "business/professional", category: "shoe"},
